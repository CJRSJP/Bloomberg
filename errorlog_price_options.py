...
def process_file_errors(bucket_name, file_list, cs):
    ...
    for file in file_list:
        ...
        cs.execute(f"SELECT COUNT(*) FROM IM_REC.CR_EPHEMERAL.PRICE_OPTIONS_ERRORS WHERE FILE_NAME = %s", (key.replace('Extracts/IDH003/ErrorLogs/', ''),))
